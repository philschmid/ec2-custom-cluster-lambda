...
for i in {1..'''+count+'''}
do
  docker run --name translator_"$i" -e AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY -e region=eu-central-1 -d 891511646143.dkr.ecr.eu-central-1.amazonaws.com/translator
done
'''
